...
2. 在联网主机上执行以下命令，并复制示例中的 manifest 内容。关于更多信息，请参阅 [manifest-example](https://github.com/whenegghitsrock/kubekey-carryon/blob/master/docs/manifest-example.md)。
   ...
   spec:
     ...
     components:
      ...
      ## The reason is KubeKey creates a cluster with containerd by installing a docker first and making kubelet connect the socket file of containerd which docker contained.
       ...
       docker-compose:
         version: v2.2.2
     images:
     - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-apiserver:v1.22.12
     - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-controller-manager:v1.22.12
     - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-proxy:v1.22.12
     - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-scheduler:v1.22.12
     - registry.cn-beijing.aliyuncs.com/kubesphereon/pause:3.5
     - registry.cn-beijing.aliyuncs.com/kubesphereon/coredns:1.8.0
     - registry.cn-beijing.aliyuncs.com/kubesphereon/cni:v3.23.2
     - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-controllers:v3.23.2
     - registry.cn-beijing.aliyuncs.com/kubesphereon/node:v3.23.2
     - registry.cn-beijing.aliyuncs.com/kubesphereon/pod2daemon-flexvol:v3.23.2
     - registry.cn-beijing.aliyuncs.com/kubesphereon/typha:v3.23.2
     ...
     - registry.cn-beijing.aliyuncs.com/kubesphereon/ks-installer:v3.3.2
     - registry.cn-beijing.aliyuncs.com/kubesphereon/ks-apiserver:v3.3.2
     - registry.cn-beijing.aliyuncs.com/kubesphereon/ks-console:v3.3.2
     - registry.cn-beijing.aliyuncs.com/kubesphereon/ks-controller-manager:v3.3.2
     - registry.cn-beijing.aliyuncs.com/kubesphereon/ks-upgrade:v3.3.2
     ...
     - registry.cn-beijing.aliyuncs.com/kubesphereon/devops-apiserver:ks-v3.3.2
     - registry.cn-beijing.aliyuncs.com/kubesphereon/devops-controller:ks-v3.3.2
     - registry.cn-beijing.aliyuncs.com/kubesphereon/devops-tools:ks-v3.3.2
     ...
     - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-state-metrics:v2.5.0
...
6. 再次执行以下命令修改集群配置文件：
   ...
   - **namespaceOverride** 增加 **kubesphereon**。
