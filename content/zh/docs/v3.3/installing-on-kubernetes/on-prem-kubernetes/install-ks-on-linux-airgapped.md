...
3. 编辑完成后保存 `cluster-configuration.yaml`。使用以下命令将 `ks-installer` 替换为您**自己仓库的地址**。
   ...
   ```bash
   sed -i "s#^\s*image: kubesphereon.*/ks-installer:.*#        image: dockerhub.kubekey.local/kubesphere/ks-installer:v3.0.0#" kubesphere-installer.yaml
   ```
...
```txt
##k8s-images
registry.cn-beijing.aliyuncs.com/kubesphereon/kube-apiserver:v1.23.10
registry.cn-beijing.aliyuncs.com/kubesphereon/kube-controller-manager:v1.23.10
registry.cn-beijing.aliyuncs.com/kubesphereon/kube-proxy:v1.23.10
registry.cn-beijing.aliyuncs.com/kubesphereon/kube-scheduler:v1.23.10
registry.cn-beijing.aliyuncs.com/kubesphereon/kube-apiserver:v1.24.3
registry.cn-beijing.aliyuncs.com/kubesphereon/kube-controller-manager:v1.24.3
registry.cn-beijing.aliyuncs.com/kubesphereon/kube-proxy:v1.24.3
registry.cn-beijing.aliyuncs.com/kubesphereon/kube-scheduler:v1.24.3
...
registry.cn-beijing.aliyuncs.com/kubesphereon/kube-apiserver:v1.21.14
registry.cn-beijing.aliyuncs.com/kubesphereon/kube-controller-manager:v1.21.14
registry.cn-beijing.aliyuncs.com/kubesphereon/kube-proxy:v1.21.14
registry.cn-beijing.aliyuncs.com/kubesphereon/kube-scheduler:v1.21.14
