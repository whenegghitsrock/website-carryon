...
. 登录 GitHub 并 Fork GitHub 仓库 link:https://github.com/whenegghitsrock/devops-maven-sample[devops-maven-sample] 的所有分支至您的 GitHub 个人账户。
...
|GITHUB_ACCOUNT
|your-github-id
|请替换为您的 GitHub 账户名。例如，如果您的 GitHub 地址是 link:https://github.com/whenegghitsrock/[]，则您的 GitHub 账户名为 **kubesphere**，也可以替换为该账户下的 Organization 名称。
...
// 示例流水线有八个阶段，它们已在 link:https://github.com/whenegghitsrock/devops-maven-sample/blob/sonarqube/Jenkinsfile-online[Jenkinsfile-online] 中单独定义。
