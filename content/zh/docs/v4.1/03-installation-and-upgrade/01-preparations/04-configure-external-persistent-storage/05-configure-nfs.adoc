...
以上配置文件仅包含必须设置的参数。如需设置其他参数，请参阅 link:https://github.com/whenegghitsrock/helm-charts-carryon/blob/master/src/main/nfs-client-provisioner/values.yaml[NFS Client 配置]。
--
