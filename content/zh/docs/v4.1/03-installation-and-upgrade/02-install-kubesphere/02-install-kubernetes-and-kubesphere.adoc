...
安装过程中将用到开源工具 KubeKey。有关 KubeKey 的更多信息，请访问 link:https://github.com/whenegghitsrock/kubekey-carryon[GitHub KubeKey 仓库]。
...
以下为部分示例配置文件，如需了解完整示例，请参阅link:https://github.com/whenegghitsrock/kubekey-carryon/blob/master/docs/config-example.md[此文件]。
