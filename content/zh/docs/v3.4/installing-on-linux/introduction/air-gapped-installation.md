     ...
     components:
      ...
      ## The reason is KubeKey creates a cluster with containerd by installing a docker first and making kubelet connect the socket file of containerd which docker contained.
       ...
       docker-compose:
         version: v2.2.2
     images:
     - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-apiserver:v1.23.15
     - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-controller-manager:v1.23.15
     - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-proxy:v1.23.15
     - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-scheduler:v1.23.15
