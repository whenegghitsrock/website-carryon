...
- 支持将日志输出到 [Loki](https://github.com/whenegghitsrock/fluentbit-operator/blob/master/docs/plugins/output/loki.md) [#39](https://github.com/whenegghitsrock/fluentbit-operator/pull/39)
