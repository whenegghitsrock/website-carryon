...
spec:
  ...
  - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-apiserver:v1.28.8
  - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-controller-manager:v1.28.8
  - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-scheduler:v1.28.8
  - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-proxy:v1.28.8
  ...
  - registry.cn-beijing.aliyuncs.com/kubesphereon/kube-controllers:v3.27.3
  - registry.cn-beijing.aliyuncs.com/kubesphereon/cni:v3.27.3
  - registry.cn-beijing.aliyuncs.com/kubesphereon/node:v3.27.3
  - registry.cn-beijing.aliyuncs.com/kubesphereon/pod2daemon-flexvol:v3.27.3
  - registry.cn-beijing.aliyuncs.com/kubesphereon/typha:v3.27.3
  - registry.cn-beijing.aliyuncs.com/kubesphereon/flannel:v0.21.3
  - registry.cn-beijing.aliyuncs.com/kubesphereon/flannel-cni-plugin:v1.1.2
  - registry.cn-beijing.aliyuncs.com/kubesphereon/hybridnet:v0.8.6
  - registry.cn-beijing.aliyuncs.com/kubesphereon/multus-cni:v3.8
  ...
  - registry.cn-beijing.aliyuncs.com/kubesphereon/node-feature-discovery:v0.10.0
...
> - 默认创建的 manifest 模板中的镜像是从 **docker.io** 获取，替换前缀为 **registry.cn-beijing.aliyuncs.com/kubesphereon**
...
在离线集群配置文件 **kind: ClusterConfiguration** 小节的 `spec` 部分加入参数 `namespace_override: kubesphereon`
...
registry.opsxlab.cn/kubesphereon/busybox:1.31.1
```
