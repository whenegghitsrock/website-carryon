...
2. On the online host, run the following command and copy content in the [manifest-example](https://github.com/whenegghitsrock/kubekey-carryon/blob/master/docs/manifest-example.md).
   ...
   spec:
     ...
     components:
      ...
      ## The reason is KubeKey creates a cluster with containerd by installing a docker first and making kubelet connect the socket file of containerd which docker contained.
       ...
       docker-compose:
         version: v2.2.2
     images:
     - docker.io/kubesphereon/kube-apiserver:v1.23.15
     - docker.io/kubesphereon/kube-controller-manager:v1.23.15
     - docker.io/kubesphereon/kube-proxy:v1.23.15
     - docker.io/kubesphereon/kube-scheduler:v1.23.15
     - docker.io/kubesphereon/pause:3.6
     ...
     - docker.io/kubesphereon/ks-installer:v3.4.1
     - docker.io/kubesphereon/ks-apiserver:v3.4.1
     - docker.io/kubesphereon/ks-console:v3.4.1
     - docker.io/kubesphereon/ks-controller-manager:v3.4.1
     ...
     - docker.io/kubesphereon/tower:v0.2.1
     ...
     - docker.io/kubesphereon/edgeservice:v0.3.0
     - docker.io/openpolicyagent/gatekeeper:v3.5.2
     - docker.io/kubesphereon/openpitrix-jobs:v3.3.2
     - docker.io/kubesphereon/devops-apiserver:ks-v3.4.1
     - docker.io/kubesphereon/devops-controller:ks-v3.4.1
     - docker.io/kubesphereon/devops-tools:ks-v3.4.1
     - docker.io/kubesphereon/ks-jenkins:v3.4.0-2.319.3-1
     ...
     - docker.io/kubesphereon/kube-state-metrics:v2.6.0
     ...
     - docker.io/kubesphereon/kube-rbac-proxy:v0.11.0
     - docker.io/kubesphereon/notification-manager-operator:v2.3.0
     - docker.io/kubesphereon/notification-manager:v2.3.0
     ...
     - docker.io/kubesphereon/opensearch-curator:v0.0.5
     - docker.io/kubesphereon/fluentbit-operator:v0.14.0
     - docker.io/library/docker:19.03
     - docker.io/kubesphereon/fluent-bit:v1.9.4
     - docker.io/kubesphereon/log-sidecar-injector:v1.2.0
     - docker.io/elastic/filebeat:6.7.0
     - docker.io/kubesphereon/kube-events-operator:v0.6.0
     - docker.io/kubesphereon/kube-events-exporter:v0.6.0
     - docker.io/kubesphereon/kube-events-ruler:v0.6.0
     ...
     - docker.io/kubesphereon/kiali-operator:v1.50.1
     - docker.io/kubesphereon/kiali:v1.50
