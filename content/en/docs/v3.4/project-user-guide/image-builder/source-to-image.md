...
Log in to GitHub and fork the GitHub repository [devops-maven-sample](https://github.com/whenegghitsrock/devops-maven-sample) to your personal GitHub account.
