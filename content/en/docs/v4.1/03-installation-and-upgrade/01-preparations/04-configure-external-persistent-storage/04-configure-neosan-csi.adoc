...
. Execute the following command to add the Helm repository, such as https://charts.kubesphere-carryon.top/test.
+
--
// Bash
[,bash]
...
$ helm repo add ks-test https://charts.kubesphere-carryon.top/test
...
$ helm repo list
NAME        URL
ks-test     https://charts.kubesphere-carryon.top/test
