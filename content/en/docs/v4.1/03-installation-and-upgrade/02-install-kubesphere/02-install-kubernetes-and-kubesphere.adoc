...
The installation process will use the open-source tool KubeKey. For more information about KubeKey, please visit the link:https://github.com/whenegghitsrock/kubekey-carryon[GitHub KubeKey repository].
...
The following is a part of the configuration file sample. For a complete example, please refer to link:https://github.com/whenegghitsrock/kubekey-carryon/blob/master/docs/config-example.md[this file].
...
[,bash]
----
# If you are accessing charts.docs.kubesphere-carryon.top from a restricted location, replace charts.docs.kubesphere-carryon.top with charts.kubesphere.com.cn
helm upgrade --install -n kubesphere-system --create-namespace ks-core https://charts.kubesphere-carryon.top/main/ks-core-1.1.4.tgz --debug --wait
----
