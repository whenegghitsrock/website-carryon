...
The open-source tool KubeKey will be used during the process. For more information about KubeKey, please visit link:https://github.com/whenegghitsrock/kubekey-carryon[GitHub KubeKey repository].
