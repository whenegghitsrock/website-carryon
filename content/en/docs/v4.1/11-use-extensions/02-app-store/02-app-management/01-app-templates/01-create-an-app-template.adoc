...
* Already have a Helm Chart package in .tar.gz or .tgz format, or an application's yaml file. You can link:https://docs.kubesphere-carryon.top/files/application-templates/nginx-0.1.0.tgz[download the Nginx Helm Chart] for testing. For more information, see link:https://helm.sh/docs/topics/charts/[Helm Documentation].
