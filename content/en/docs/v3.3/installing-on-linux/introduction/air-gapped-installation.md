...
2. On the online host, run the following command and copy content in the [manifest-example](https://github.com/whenegghitsrock/kubekey-carryon/blob/master/docs/manifest-example.md).
   ...
   spec:
     ...
     components:
      ...
      ## The reason is KubeKey creates a cluster with containerd by installing a docker first and making kubelet connect the socket file of containerd which docker contained.
       ...
       docker-compose:
         version: v2.2.2
     images:
     - docker.io/kubesphereon/kube-apiserver:v1.22.12
     - docker.io/kubesphereon/kube-controller-manager:v1.22.12
     - docker.io/kubesphereon/kube-proxy:v1.22.12
     - docker.io/kubesphereon/kube-scheduler:v1.22.12
     - docker.io/kubesphereon/pause:3.5
     ...
     - docker.io/kubesphereon/flannel:v0.12.0
     - docker.io/openebs/provisioner-localpv:3.3.0
     - docker.io/openebs/linux-utils:3.3.0
     - docker.io/library/haproxy:2.3
     - docker.io/kubesphereon/nfs-subdir-external-provisioner:v4.0.2
     - docker.io/kubesphereon/k8s-dns-node-cache:1.15.12
     - docker.io/kubesphereon/ks-installer:v3.3.2
     - docker.io/kubesphereon/ks-apiserver:v3.3.2
     - docker.io/kubesphereon/ks-console:v3.3.2
     - docker.io/kubesphereon/ks-controller-manager:v3.3.2
     - docker.io/kubesphereon/ks-upgrade:v3.3.2
     - docker.io/kubesphereon/kubectl:v1.22.0
     - docker.io/kubesphereon/kubectl:v1.21.0
     - docker.io/kubesphereon/kubectl:v1.20.0
     - docker.io/kubesphereon/kubefed:v0.8.1
     - docker.io/kubesphereon/tower:v0.2.0
     ...
     - docker.io/kubesphereon/nginx-ingress-controller:v1.1.0
     - docker.io/mirrorgooglecontainers/defaultbackend-amd64:1.4
     - docker.io/kubesphereon/metrics-server:v0.4.2
     - docker.io/library/redis:5.0.14-alpine
     - docker.io/library/haproxy:2.0.25-alpine
     - docker.io/library/alpine:3.14
     - docker.io/osixia/openldap:1.3.0
     - docker.io/kubesphereon/netshoot:v1.0
     - docker.io/kubeedge/cloudcore:v1.9.2
     - docker.io/kubeedge/iptables-manager:v1.9.2
     - docker.io/kubesphereon/edgeservice:v0.2.0
     - docker.io/openpolicyagent/gatekeeper:v3.5.2
     - docker.io/kubesphereon/openpitrix-jobs:v3.3.2
     - docker.io/kubesphereon/devops-apiserver:ks-v3.3.2
     - docker.io/kubesphereon/devops-controller:ks-v3.3.2
     - docker.io/kubesphereon/devops-tools:ks-v3.3.2
     - docker.io/kubesphereon/ks-jenkins:v3.3.0-2.319.1
     - docker.io/jenkins/inbound-agent:4.10-2
     - docker.io/kubesphereon/builder-base:v3.2.2
     - docker.io/kubesphereon/builder-nodejs:v3.2.0
     - docker.io/kubesphereon/builder-maven:v3.2.0
     - docker.io/kubesphereon/builder-maven:v3.2.1-jdk11
     - docker.io/kubesphereon/builder-python:v3.2.0
     - docker.io/kubesphereon/builder-go:v3.2.0
     - docker.io/kubesphereon/builder-go:v3.2.2-1.16
     - docker.io/kubesphereon/builder-go:v3.2.2-1.17
     - docker.io/kubesphereon/builder-go:v3.2.2-1.18
     - docker.io/kubesphereon/builder-base:v3.2.2-podman
     - docker.io/kubesphereon/builder-nodejs:v3.2.0-podman
     - docker.io/kubesphereon/builder-maven:v3.2.0-podman
     - docker.io/kubesphereon/builder-maven:v3.2.1-jdk11-podman
     - docker.io/kubesphereon/builder-python:v3.2.0-podman
     - docker.io/kubesphereon/builder-go:v3.2.0-podman
     - docker.io/kubesphereon/builder-go:v3.2.2-1.16-podman
     - docker.io/kubesphereon/builder-go:v3.2.2-1.17-podman
     - docker.io/kubesphereon/builder-go:v3.2.2-1.18-podman
     - docker.io/kubesphereon/s2ioperator:v3.2.1
     - docker.io/kubesphereon/s2irun:v3.2.0
     - docker.io/kubesphereon/s2i-binary:v3.2.0
     - docker.io/kubesphereon/tomcat85-java11-centos7:v3.2.0
     - docker.io/kubesphereon/tomcat85-java11-runtime:v3.2.0
     - docker.io/kubesphereon/tomcat85-java8-centos7:v3.2.0
     - docker.io/kubesphereon/tomcat85-java8-runtime:v3.2.0
     - docker.io/kubesphereon/java-11-centos7:v3.2.0
     - docker.io/kubesphereon/java-8-centos7:v3.2.0
     - docker.io/kubesphereon/java-8-runtime:v3.2.0
     - docker.io/kubesphereon/java-11-runtime:v3.2.0
     - docker.io/kubesphereon/nodejs-8-centos7:v3.2.0
     - docker.io/kubesphereon/nodejs-6-centos7:v3.2.0
     - docker.io/kubesphereon/nodejs-4-centos7:v3.2.0
     - docker.io/kubesphereon/python-36-centos7:v3.2.0
     - docker.io/kubesphereon/python-35-centos7:v3.2.0
     - docker.io/kubesphereon/python-34-centos7:v3.2.0
     - docker.io/kubesphereon/python-27-centos7:v3.2.0
     ...
     - docker.io/kubesphereon/prometheus-config-reloader:v0.55.1
     - docker.io/kubesphereon/prometheus-operator:v0.55.1
     - docker.io/kubesphereon/kube-rbac-proxy:v0.11.0
     - docker.io/kubesphereon/kube-state-metrics:v2.5.0
     ...
     - docker.io/kubesphereon/kube-rbac-proxy:v0.8.0
     - docker.io/kubesphereon/notification-manager-operator:v1.4.0
     - docker.io/kubesphereon/notification-manager:v1.4.0
     - docker.io/kubesphereon/notification-tenant-sidecar:v3.2.0
     - docker.io/kubesphereon/elasticsearch-curator:v5.7.6
     - docker.io/kubesphereon/elasticsearch-oss:6.8.22
     - docker.io/kubesphereon/fluentbit-operator:v0.13.0
     - docker.io/library/docker:19.03
     - docker.io/kubesphereon/fluent-bit:v1.8.11
     - docker.io/kubesphereon/log-sidecar-injector:1.1
     - docker.io/elastic/filebeat:6.7.0
     - docker.io/kubesphereon/kube-events-operator:v0.4.0
     - docker.io/kubesphereon/kube-events-exporter:v0.4.0
     - docker.io/kubesphereon/kube-events-ruler:v0.4.0
     - docker.io/kubesphereon/kube-auditing-operator:v0.2.0
     - docker.io/kubesphereon/kube-auditing-webhook:v0.2.0
     ...
     - docker.io/kubesphereon/kiali-operator:v1.38.1
     - docker.io/kubesphereon/kiali:v1.38
     ...
     - docker.io/kubesphereon/examples-bookinfo-productpage-v1:1.16.2
     - docker.io/kubesphereon/examples-bookinfo-reviews-v1:1.16.2
     - docker.io/kubesphereon/examples-bookinfo-reviews-v2:1.16.2
     - docker.io/kubesphereon/examples-bookinfo-details-v1:1.16.2
     - docker.io/kubesphereon/examples-bookinfo-ratings-v1:1.16.3
...
6. Run the following command again to modify the cluster configuration file：
   ...
   - In **namespaceOverride**, enter **kubesphereon**.
