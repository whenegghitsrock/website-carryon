...
If the cluster node used to perform the operations cannot connect to the internet, you can manually link:https://github.com/whenegghitsrock/kubekey-carryon/releases[download KubeKey] on a device with internet access and then transfer it to the cluster node.
