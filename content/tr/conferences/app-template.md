...
1.2. Fill in the basic information, name it as demo-repo and input the URL with `https://charts.kubesphere-carryon.top/main`, you can validate if this URL is available, choose **OK** when you've done.
